            ...
            <?php else: ?>
                ...
                <div class="mobile-cart-items">
                    <?php foreach ($cart_items as $cart_item_id => $item_data):
                        ...
                        // Get image
                        if (!empty($variant) && !empty($variant['image'])) {
                            // Variant image
                            $image_path = $site . 'admin/assets/img/uploads/variants/' . $variant['image'];
                        } elseif (!empty($product['pro_img'])) {
                            // Product image
                            $image_path = $site . 'admin/assets/img/uploads/' . $product['pro_img'];
                        } else {
                            // Fallback
                            $image_path = $site . 'assets/img/s-product/product.jpg';
                        }
        ...
        $('.quantity-btn').click(function() {
            ...
            if ($(this).hasClass('plus')) {
                if (currentVal < maxVal) {
                    ...
                    input.val(newVal);
                    updateCartItem(cartItemId, newVal);
                } else {
        ...
        function updateCartItem(cartItemId, quantity) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        // Update item total in desktop view
                        ...
                        // Update item total in mobile view
                        var mobileItem = $('.mobile-cart-item[data-cart-item-id="' + cartItemId + '"]');
                        mobileItem.find('.mobile-product-total').text('₹' + response.item_total);
                        
                        // Update cart totals
                        $('.cart_amount:first').text('₹' + response.subtotal);
