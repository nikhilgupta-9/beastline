...
<body>
    ...
    $customer_email = $billing_address['email'] ?? $shipping_address['email'];
    $customer_phone = $billing_address['phone'] ?? $shipping_address['phone'];
        ...
        <div class="confirmation-container">
            ...
            <div class="order-details">
                ...
                <div class="order-detail-row">
                    ...
                    <span class="badge bg-<?=
                                            $order['order_status'] == 'confirmed' ? 'success' : ($order['order_status'] == 'pending' ? 'warning' : ($order['order_status'] == 'shipped' ? 'info' : ($order['order_status'] == 'delivered' ? 'success' : 'secondary')))
                                            ?>">
