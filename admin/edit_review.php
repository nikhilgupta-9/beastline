...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_review'])) {
    ...
    $status = $_POST['status'];
    $image_path = $review['reviewver_img'];
    ...
    if (empty($error)) {
        ...
        if (empty($error)) {
            $stmt = $conn->prepare("UPDATE product_reviews 
                                   ...
                                   WHERE review_id = ?");
            $stmt->bind_param("issssii", $rating, $review_message, $reviewer_name, 
                              $reviewer_email, $image_path, $status, $review_id);
                                ...
                                <div class="form-container">
                                    <form method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="mb-3">
                                        ...
                                        <div class="mb-3 col-md-3 col-sm-12">
                                            <label for="reviewer_email" class="form-label">Reviewer Status</label>
